...
RESULT_SPECS: List[ResultSpec] = [
    ...
    ResultSpec("detected-symbols", "parse_results.csv", "symbol-parse-results"),
    ResultSpec("detected-symbols", "symbols.csv", "symbols"),
    ResultSpec("detected-symbols", "symbol_children.csv", "symbol-children"),
    ResultSpec("detected-symbols", "symbol_tokens.csv", "symbol-tokens"),
    ResultSpec("detected-symbols", "entities.csv", "tokens"),
    ResultSpec(
