...
def test_map_to_initial_offsets():
    ...
    assert s.initial_offsets(8, 9) == (8, 14)
    assert s.initial_offsets(9, 9) == (8, 14)
    assert s.initial_offsets(15, 15) == (14, 14)
...
def test_map_to_mutated_offsets():
    ...
    assert s.current_offsets(0, 1) == (0, 1)
    assert s.current_offsets(9, 9) == (8, 15)
