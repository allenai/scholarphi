  ...
  render() {
    ...
    const portalValue = (<div className="brandbar">
      <div className="brandbar__left">
        <S2LogoMarkOnly /> Semantic Reader | In collaboration with UC Berkeley
      </div>
...
function S2LogoMarkOnly() {
  return (
    <svg
      ...
      role="img"
      className="s2-logo s2-logo--logo-only">
      <title id="logoTitle">Semantic Scholar</title>
      <desc id="logoDesc">Semantic Scholar's Logo</desc>
      <g className="s2-logo__mark">
        <path
          className="s2-logo__checkmark"
